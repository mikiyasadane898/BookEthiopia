...
export default function BookCar({isOpen, setIsOpen, carName}) {
...
<div className="fixed inset-0 bg-black/35 flex items-center justify-center">
    {/* Popup Form */}
    <div className="rounded-l-lg flex flex-col lg:max-w-[90vh] mx-auto text-gray-800 bg-white max-h-[80vh] overflow-auto ">
      

          
          <div className=" flex items-center  pb-10 pt-5  px-6 ">
           <Ticket className="  size-7  mr-1 text-yellow-600" strokeWidth={2} />
            ...
            <p className=" text-sm text-gray-600">
              ...
              <button className="hover:bg-amber-50 p-2 ml-auto cursor-pointer" onClick={()=>setIsOpen(false)}>
                <X />
              </button>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:space-x-6 pl-6 space-y-6">
           ...
           <div className=" flex flex-col ">
              ...
              <select name="pick_up_location" className="mt-2  border border-gray-300 rounded-md py-3 pl-2 outline-0 cursor-pointer ">
                <option value="Addis Ababa Bole Airport" className="cursor-pointer">
                  Addis Ababa Bole Airport
                </option>
                <option value="Addis Ababa City Center" className="cursor-pointer">
                  Addis Ababa City Center
                </option>
                <option value="Bahir Dar" className="cursor-pointer">
                 Bahir Dar
                </option>
                <option value="Gonder" className="cursor-pointer">
                  Gonder
                </option>
                <option value="Lalibela" className="cursor-pointer">
                  Lalibela
                </option>
              </select>
            </div>
            ...
            <div className="flex flex-col text-sm  leading-6 p-4">
              ...
              <span className="flex justify-between border-t pt-2 border-amber-200 ">
                ...
                <p className="text-yellow-600">4,175 ETB</p>
              </span>
            ...
            <div className="flex justify-around space-x-4 my-6 mx-5 text-black font-semibold ">
              <button className=" cursor-pointer hover:bg-amber-100/70   w-full py-3 rounded-lg text-lg" onClick={()=> setIsOpen(false)}>Cancel</button>
              <button className=" cursor-pointer bg-yellow-500 contrast-75 w-full py-3 rounded-lg text-lg">Confirm Booking</button>
            </div>
        </div>
        </div>
      )}
