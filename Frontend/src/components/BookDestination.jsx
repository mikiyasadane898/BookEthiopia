...
export default function BookDestination({isOpen, setIsOpen, destinationName}) {
    ...
    <div className="rounded-l-lg flex flex-col lg:max-w-[90vh] mx-auto text-gray-800 bg-white max-h-[80vh] overflow-auto ">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:space-x-6 pl-6 space-y-6">
           ...
           <div className=" flex flex-col ">
              ...
              <select name="ticket_number" className="mt-4  border border-gray-300 rounded-md py-3 pl-2 outline-0 cursor-pointer ">
                ...
                <option value="4" className="cursor-pointer">
                  4 Ticket{" "}
                </option>
